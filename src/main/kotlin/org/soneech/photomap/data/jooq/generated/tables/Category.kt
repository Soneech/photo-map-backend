...
open class Category(
     ...
     */
    val ID: TableField<org.soneech.photomap.`data`.jooq.generated.tables.records.CategoryRecord, Long?> = createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false), this, "")
